...
| `aspectRatio`     | No       | Aspect ratio (default `1:1`); clamped to the model's supported set. See [Aspect Ratios and Resolution](/docs/protocol/agent-config#aspect-ratios-and-resolution) |
